...
public class DetailsFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tf_l= Typeface.createFromAsset(getActivity().getAssets(), "MarkOffcPro-Medium.ttf");
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.menu_chat:
                        ...
                        MainActivity.chatInitializerProjectXCode = MedicineDetailsActivity2.truemdCode;
                        Intent toMainProjectXSiriFragment = new Intent(getActivity(), MainActivity.class);
                        startActivity(toMainProjectXSiriFragment);
                        break;
...
//
    ...
    public void openBottomSheetSideEffects ( String heading, String content, String medname, String link) {
        ...
        Typeface tf_r= Typeface.createFromAsset(getActivity().getAssets(), "MarkOffcPro-Medium.ttf");
        Typeface tf_b= Typeface.createFromAsset(getActivity().getAssets(), "fonts/OpenSans-Bold.ttf");
        ...
        protected String doInBackground(String... messageText) {
            ...
            try {
                ...
                if (line.length() > 5) {
                    ...
                    preg = "\n \n <b> Pregnancy Category: "+ ProjectXJSONUtils.goThroughNullCheck(medicineJsonObject.getJSONObject("pregnancy").getString("category"))+": "+
                            ProjectXJSONUtils.goThroughNullCheck(medicineJsonObject.getJSONObject("pregnancy").getString("label")) +"</b>";


                    preg += "\n"+ ProjectXJSONUtils.goThroughNullCheck(medicineJsonObject.getJSONObject("pregnancy").getString("description")) ;

                    lact = "\n \n <b> Lactation Category: "+ ProjectXJSONUtils.goThroughNullCheck(medicineJsonObject.getJSONObject("lactation").getString("category"))+": "+
                            ProjectXJSONUtils.goThroughNullCheck(medicineJsonObject.getJSONObject("lactation").getString("label")) +"</b>";


                    lact += "\n"+ ProjectXJSONUtils.goThroughNullCheck(medicineJsonObject.getJSONObject("lactation").getString("description")) ;
                    ...
                    for(int i = 0; i < genericsJsonArray.length(); i++){
                       ...
                       //genMed.setHow(r.optString("how"));
                        ...
                        try {
                            JSONObject ml = ProjectXJSONUtils.nullSafeJSONObject(r.getJSONObject("medline"));
...
//                            getSupportActionBar().setTitle("ProjectX");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                nameMD.setText(ProjectXJSONUtils.goThroughNullCheck(med.getName()));
                manufacturerMD.setText(ProjectXJSONUtils.goThroughNullCheck(med.getMf()));
                priceMD.setText("\u20B9 "+ProjectXJSONUtils.goThroughNullCheck(med.getMrp()));
                sizeMD.setText(ProjectXJSONUtils.goThroughNullCheck(med.getpSize()));
                scheduleMD.setText(ProjectXJSONUtils.goThroughNullCheck(med.getSchedule()));
            ...
            constituentsMD.setText("Contains: " + ProjectXJSONUtils.goThroughNullCheck(cons));

            for(Generic genmed: med.getGenerics())
            {
                sideEffects+= "<b>"+ ProjectXJSONUtils.goThroughNullCheck(genmed.getName())+"</b>"+"\n";
                sideEffects+= ProjectXJSONUtils.goThroughNullCheck(genmed.getSe())+"\n\n";

                precautions+= "<b>"+ProjectXJSONUtils.goThroughNullCheck(genmed.getName())+"</b>"+"\n";
                precautions+= ProjectXJSONUtils.goThroughNullCheck(genmed.getMedline().getPrecaution())+"\n\n";

                why+= "<b>"+ProjectXJSONUtils.goThroughNullCheck(genmed.getName())+"</b>"+"\n";
                why+= ProjectXJSONUtils.goThroughNullCheck(genmed.getMedline().getWhy())+"\n\n";

                how+= "<b>"+ProjectXJSONUtils.goThroughNullCheck(genmed.getName())+"</b>"+"\n";
                how+= ProjectXJSONUtils.goThroughNullCheck(genmed.getMedline().getHow())+"\n\n";

                diet+= "<b>"+ProjectXJSONUtils.goThroughNullCheck(genmed.getName())+"</b>"+"\n";
                diet+= ProjectXJSONUtils.goThroughNullCheck(genmed.getMedline().getDiet())+"\n\n";

                storage+= "<b>"+ProjectXJSONUtils.goThroughNullCheck(genmed.getName())+"</b>"+"\n";
                storage+= ProjectXJSONUtils.goThroughNullCheck(genmed.getMedline().getStorage())+"\n\n";

                faqs+= "<b>"+ProjectXJSONUtils.goThroughNullCheck(genmed.getName())+"</b>"+"\n";
                faqs+= ProjectXJSONUtils.goThroughNullCheck(genmed.getFaqs())+"\n\n";
