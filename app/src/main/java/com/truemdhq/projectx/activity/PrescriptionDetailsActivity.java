...
public class PrescriptionDetailsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        presNo = presNo.substring(presNo.indexOf('#')+5);
            ...
            tv1.setText(date);
            //tv2.setText(presNo);
            tv3.setText(ProjectXJSONUtils.goThroughNullCheck(presNo));
            tv4.setText(ProjectXJSONUtils.goThroughNullCheck(name));
            tv5.setText(ProjectXJSONUtils.goThroughNullCheck(doctorname));
           // tv6.setText();
...
//        getApplicationContext().startActivity(intent_main);
    ...
    public void openBottomSheetPatientInfo ( String heading, String content, String age, String gender) {
        ...
        txtg.setText(ProjectXJSONUtils.goThroughNullCheck(gender));
        txth.setText(ProjectXJSONUtils.goThroughNullCheck(heading));
        txtc.setText("");
        txta.setText(ProjectXJSONUtils.goThroughNullCheck(age));
    ...
    public void openBottomSheetDoctorInfo ( String heading, String qual, String address, String contact, String registration) {
        ...
        txtr.setText(ProjectXJSONUtils.goThroughNullCheck(registration));
        txth.setText(ProjectXJSONUtils.goThroughNullCheck(heading));
        txtq.setText(ProjectXJSONUtils.goThroughNullCheck(qual));
        txta.setText(ProjectXJSONUtils.goThroughNullCheck(address));
        txtc.setText(ProjectXJSONUtils.goThroughNullCheck(contact));
