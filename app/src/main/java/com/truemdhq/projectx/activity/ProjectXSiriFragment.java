 ...
 */
public class ProjectXSiriFragment extends Fragment {
...
//                .create();
    ...
    private void loadDummyHistory(){
        ...
        adapter = new ChatAdapter((MainActivity)context, new ArrayList<ChatMessage>(), ProjectXSiriFragment.this);
        messagesContainer.setAdapter(adapter);

        new InitializeNetworkOperation().execute(MainActivity.chatInitializerProjectXCode);
        ...
        protected String[] doInBackground(String... messageText) {
            ...
            try {
               ...
               if(messageText[0].contains("#")) {
                ...
                //URL js = new URL(MainActivity.app_url+"/api/v2/medicines?key="+MainActivity.dev_key+"&search="+messageText[0]);
                //URL js= new URL(MainActivity.app_url+"/getentity.json?key="+MainActivity.dev_key+"&q="+temp+"&fuzziness="+fuzzi+"&size=15&chat_id="+user.get(SessionManager.KEY_CHAT_ID_UM));
                URL js1= new URL(MainActivity.app_url+"/step1.json?key="+MainActivity.dev_key+"&q="+temp+"&fuzziness="+fuzzi+"&intent_override_flag="+intent_override_flagS1+"&size=5&chat_id="+user.get(SessionManager.KEY_CHAT_ID_UM));
    ...
    public class ExecuteNetworkOperation2 extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... messageText) {
            ...
            try {
                ...
                HashMap<String, String> user = session.getUserDetails();
                 URL js= new URL(MainActivity.app_url+"/step2.json?key="+MainActivity.dev_key+"&chat_id="+user.get(SessionManager.KEY_CHAT_ID_UM)+"&truemdCode="+trueMDCode+"&intent="+intentS1+"&name="+trueMDName);
    ...
    public class InitializeNetworkOperation extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... messageText) {
            ...
            try {
                ...
                HashMap<String, String> user = session.getUserDetails();
                URL js= new URL(MainActivity.app_url+"/initialize_chat.json?chat_id="+user.get(SessionManager.KEY_CHAT_ID_UM)+"&truemdCode="+trueMDCode+"&key="+MainActivity.dev_key);
                ...
                if (line.length() > 5) {
                    ...
                    MainActivity.chatInitializerProjectXName=entity.getString("primary_entity_name");
