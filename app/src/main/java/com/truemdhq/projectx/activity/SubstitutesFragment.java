...
public class SubstitutesFragment extends Fragment {
    ...
    String [] NameListA,ManufacturerListA,PriceListA,PackSizeListA,ProjectXCodeListA, UnitPriceListA;
        ...
        protected String doInBackground(String... messageText) {
            ...
            try {
                ...
                if (messageText[0].length() != 0) {
                    ...
                    URL js = new URL(MainActivity.app_url+"/api/v2/medicines/"+trueMDCode+"/alternatives?key=" + MainActivity.dev_key);
...
//                    line = reader.readLine();
                    if (line.length() > 5) {
                        ...
                        ProjectXCodeListA = new String[jsonAlternatives.length()];
                        ...
                        for (int i = 0; i < jsonAlternatives.length(); i++) {
                            ...
                            if(toGoInSubstitues){
                                ...
                                ProjectXCodeListA[k]=r.getString("truemdId");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                {
                    lv.setAdapter(new CustomSubstitutesAdapter(getActivity(), NameListA, ManufacturerListA, PriceListA, PackSizeListA, ProjectXCodeListA, UnitPriceListA));
                }

                NameListA= new String[1];
                ProjectXCodeListA = new String[1];
