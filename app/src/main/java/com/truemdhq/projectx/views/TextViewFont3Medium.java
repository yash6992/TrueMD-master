 ...
 */
public class TextViewFont3Medium extends TextView {

    public TextViewFont3Medium(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public TextViewFont3Medium(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextViewFont3Medium(Context context) {
        super(context);
        init();
    }
