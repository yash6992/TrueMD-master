 ...
 */
public class TextViewFont2Large extends TextView {

    public TextViewFont2Large(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public TextViewFont2Large(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextViewFont2Large(Context context) {
        super(context);
        init();
    }
