 ...
 */
public class TextViewFont1Medium extends TextView {

    public TextViewFont1Medium(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public TextViewFont1Medium(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextViewFont1Medium(Context context) {
        super(context);
        init();
    }
