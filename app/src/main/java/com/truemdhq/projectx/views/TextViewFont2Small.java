 ...
 */
public class TextViewFont2Small extends TextView {

    public TextViewFont2Small(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public TextViewFont2Small(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextViewFont2Small(Context context) {
        super(context);
        init();
    }
