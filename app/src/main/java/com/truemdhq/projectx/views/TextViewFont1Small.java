 ...
 */
public class TextViewFont1Small extends TextView {

    public TextViewFont1Small(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public TextViewFont1Small(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TextViewFont1Small(Context context) {
        super(context);
        init();
    }
