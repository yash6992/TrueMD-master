    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if (medObjArray[position].length() < 1)
                ...
                String frequency_daily=""+ ProjectXJSONUtils.goThroughNullCheck(med.getString("daily_frequency"));
                String frequency_weekly=""+ProjectXJSONUtils.goThroughNullCheck(med.getString("weekly_frequency"));
                String frequency_monthly=""+ProjectXJSONUtils.goThroughNullCheck(med.getString("monthly_frequency"));
