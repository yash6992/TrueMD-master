...
import com.truemdhq.projectx.activity.ProjectXSiriFragment;
...
public class ChatAdapter extends BaseAdapter {
    ...
    private ProjectXSiriFragment fragment;
    private Activity context;boolean wordClicked = false;

    Vibrator vibrator ;//= (Vibrator)getSystemService(Context.VIBRATOR_SERVICE);


    public ChatAdapter(Activity context, List<ChatMessage> chatMessages, ProjectXSiriFragment fragment) {
    ...
    private class DictionaryTask extends AsyncTask<String, String, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                resp[0] = ProjectXJSONUtils.goThroughNullCheck(response.getString("heading"));
                resp[1] =  ProjectXJSONUtils.goThroughNullCheck(response.getString("content"));
                resp[2] =  ProjectXJSONUtils.goThroughNullCheck(response.getString("link"));
