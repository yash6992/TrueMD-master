 ...
 */
public class RefillAddAddressActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        session = new SessionManager(RefillAddAddressActivity.this);
            ...
            try {
                if (jsonObject.toString().length() > 5) {
                    ...
                    try {
                        ...
                        RefillOrderActivity.deliveryAddressFinal=value;
                        RefillOrderActivity.selectedAddressjobj= addressJsonObject.getJSONObject("address");
                    ...
                    Toast.makeText(RefillAddAddressActivity.this, "User address added.", Toast.LENGTH_SHORT).show();
                    finish();
