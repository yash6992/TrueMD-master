...
import info.truemd.android.adapter.CustomSubstitutesAdapter;
...
public class UpcomingOrderFragment extends Fragment {
    ...
    public void getUpcomingOrder(){
        ...
        try {
            ...
            mRequester.request(Methods.GET, MainActivity.app_url+"/orders.json?status_not=ODel,OCan,ORej,ORef");
    ...
    public String statusToDots(String status){
        ...
        if(status.equalsIgnoreCase("ODis")||status.equalsIgnoreCase("ODel"))
            ...
            dots=""+3;
        else if(status.equalsIgnoreCase("ODig")||status.equalsIgnoreCase("OVer")||status.equalsIgnoreCase("QAs0")
                ||status.equalsIgnoreCase("OAva")||status.equalsIgnoreCase("OPro")||status.equalsIgnoreCase("OPre"))
            dots=""+2;
        else if(status.equalsIgnoreCase("OCap")||status.equalsIgnoreCase("OVal")||status.equalsIgnoreCase("OBuf"))
            dots=""+1;
