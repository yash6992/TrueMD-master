...
public class Intro extends AppIntro {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        //addSlide(AppIntroFragment.newInstance("Welcome to TrueMD", "Your Local Pharmacy, Reinvented",R.mipmap.ic_launcher,c.getResources().getColor(R.color.windowBackground) ));

// Instead of fragments, you can also use our default slide
        // Just set a title, description, background and image. AppIntro will do the rest.
        //addSlide(AppIntroFragment.newInstance("Welcome to TrueMD", "Your Local Pharmacy, Reinvented",R.drawable.sunrise,c.getResources().getColor(R.color.windowBackground) ));
