    ...
    public void openBottomSheet( String heading,  String link) {
       ...
       // WebView wv = (WebView) view.findViewById(R.id.webView);
        ...
        String r="Terms and Conditions\n" +
                "The website and/or mobile application (hereinafter defined) is owned and operated by TrueMD technologies private limited (hereinafter referred to as “TrueMD”, “TrueMD.in”, “company”, “we”, ”our” or “us”, which term shall include its successors and permitted assigns).\n" +
                "The following are the terms and conditions, read together with the privacy policy, that govern your purchase and use of the products and services (the \"products\") from TrueMD.in, and constitute a legally binding agreement, between you (referred to as “you”, “your”, “customer\" or \"user\", which shall also include persons merely visiting the website/app and/or contacting TrueMD via third party applications including but not limited to Whatsapp messenger) and TrueMD.\n" +
                ...
                "\n" +
                "User account\n" +
                "To use certain features of the website  and/or app (e.g., ordering products, posting rating/reviews, receiving TrueMD notifications), you must set up an account with TrueMD and provide certain information about yourself as prompted by the account creation form, including without limitation, your name, gender, email address, account password, mobile phone number and billing/shipping address. All of your registration information is protected by our privacy policy.\n" +
                ...
                "You agree and confirm that you are over 18 years of age at the time of creation of your TrueMD account. TrueMD is not intended for children under the age of 18.\n" +
                "TrueMD will not be liable for any loss or damages as a result of your failure to maintain the confidentiality of your account credentials. If you suspect any unauthorised use of your TrueMD account, you shall immediately notify TrueMD.\n" +
                "By registering, accessing or using the website, you accept the terms of this terms of use and represent and warrant to TrueMD that you are ‘competent to contract’ under the contract act and have the right, authority and capacity to use the website and agree to and abide by its terms of use.\n" +
                "Placing orders\n" +
                "In order to use the services, you must provide certain personal and medical information about yourself or those for whom you are authorized to present prescriptions (the “patient”). You may voluntarily submit, and hereby authorize TrueMD, its employees, agents and others operating on its behalf, to use and/or disclose personal and health-related information about the patient, in order to provide the services to you, in accordance with our privacy policy, including, without limitation, the patient’s name, age, gender, mobile number, email address, delivery address, image of the insurance card, image of the prescription and other information you provide through the app that is either requested by TrueMD or volunteered by you (“personal information”). Please review the privacy policy carefully, as your use of the app constitutes your agreement to the privacy policy.\n" +
                ...
                "You agree to be contacted by TrueMD at the mobile telephone number you provide for the purpose of confirming your prescription and scheduling the delivery of your prescribed medication. Standard telephone minute charges may apply if we contact you at a mobile number or device.\n" +
                ...
                "The content of the website/app, including without limitation, text, photographs and graphics, is owned by us and our licensors and is protected by copyright, trademark, patent, and trade secret laws, other proprietary rights, and international treaties. You acknowledge that the services and any underlying technology or software used in connection with the services contain TrueMD’s proprietary information. We give you permission to use the aforementioned content for personal, non-commercial purposes only and do not transfer any intellectual property rights to you by virtue of permitting your use of the services. \n" +
                "You hereby agree that you will not reproduce, duplicate or copy the content of TrueMD for any purpose, unless you have been specifically permitted to do so in a separate agreement with this website. \n" +
                " Disclaimer of warranties and limitation of liability\n" +
                "•\tAll information, products and services included on or otherwise made available to you through this website are provided by TrueMD on an \"as is\" and \"as available\" basis, either expressed or implied, we specifically disclaim warranties of any kind to the extent allowed by the applicable law. You expressly agree that your use of this website is at your sole risk.\n" +
                "\n" +
                "•\tTrueMD shall not be responsible for any adverse, desirous or any other kind of harm in the body as they are mere suppliers of ‘already manufactured’ medicines under different brands and there shall be no guarantee for the effects after consumption of the medicines and the role of TrueMD would be only to supply medicines as per demand and such medicine is purchased by TrueMD in pre-sealed and pre-packed condition from the different manufactures of the medicine.\n" +
                "\n" +
                "•\tTrueMD assumes no responsibility for any damages or viruses that may infect your computer equipment or other property on account of your access to, use of, or browsing in this site.\n" +
                "\n" +
                ...
                "\n" +
                "•\tTrueMD cannot guarantee the adequacy, currency or completeness of the website content. Truemd does not warrant or endorse the effectiveness, quality or safety of the products available on its website. \n" +
                "\n" +
                "•\tWe disclaim responsibility for any harm to persons resulting from any instructions or products referred to in the website. TrueMD is not associated with any manufacturer of medicines or other products on the website. We do not warrant that the website, or its content will meet your requirements.\n" +
                "\n" +
                ...
                "\n" +
                "•\tThe company TrueMD shall not be responsible for the effects of the medicines. Their limited responsibility would be to supply and facilitate the customer by providing/ delivering the medicines strictly as per the prescription of a qualified doctor supplied to the company by the customer. The company TrueMD shall not be liable for the supply of medicines based on the false or incorrect prescription supplied by the customer. \n" +
                "\n" +
                ...
                "\n" +
                "•\tTrueMD reserves the right to modify or withdraw any part of the website or any of its content at any time without notice.\n" +
                "Indemnification\n" +
                ...
                "\n" +
                "•\tThe user/customer shall be prohibited to introduce, post, or transmit any information or software, which contains a virus, worm or other harmful components into the TrueMD website.  \n" +
                "\n" +
                "•\tTrueMD does not endorse and is not responsible for any submissions on its website. We will not be liable for any loss or harm caused by the submissions or your reliance on the information, including but not limited to, statements, opinions and reviews posted by the users/customers, which may be inaccurate, offensive, obscene, threatening or harassing.  \n" +
                ...
                "•\tTrueMD will not dispense any prescription medication without a valid prescription from a licensed physician. TrueMD may, at its discretion, share your prescription and other pertinent information with a third-party network of certified medical doctors.\n" +
                "\n" +
                ...
                "\n" +
                "•\tThe drug information provided in the TrueMD website/app is for informative purposes only and this website is not intended to provide diagnosis, treatment or medical advice. We are not liable for any adverse effects or harm to you as a result of your reliance on the information in the website.  \n" +
                "\n" +
                "•\tTrueMD requires either the user or customer or the caregiver to confirm he/she is completely aware of the indications, side effects, drug interactions, effects of missed dose or overdose of the medicines he/she orders from us. It is imperative to seek professional advice from your physician before purchasing or consuming any medicine from TrueMD.\n" +
                ...
                "•\tReturns shall be accepted only in case of wrong medicines or expired medicines delivered. TrueMD shall verify such a claim and only after confirmation of genuineness of claim shall the return be set into motion.\n" +
                "Terms of sale\n" +
                "•\tTrueMD may accept or decline any order placed by a customer in its absolute discretion without liability to you.\n" +
                "•\tTrueMD reserves the right to discontinue any program or offer on its website.\n" +
                "•\tWe reserve the right, without prior notice, to limit the order quantity of any products available on TrueMD.\n" +
                "\n" +
                "We acknowledge and you agree that you have fully and accurately disclosed your personal information and personal health information and consent to its use by the pharmacy TrueMD and/or its affiliates. You confirm that you have had a physical examination by a physician and do not require a physical examination.\n" +
                "\n" +
                "You understand that all products shall be sold & dispensed by a registered pharmacist at TrueMD and/or its affiliates.\n" +
                ...
                "Note:\n" +
                "These terms of use and any supplemental terms, policies, rules and guidelines on the app, including the privacy policy, constitute the entire agreement between you and us and supersede all previous written or oral agreements. If any part of these terms of use is held invalid or unenforceable, that portion shall be construed in a manner consistent with applicable law to reflect, as nearly as possible, the original intentions of the parties, and the remaining portions shall remain in full force and effect. The failure of TrueMD to exercise or enforce any right or provision of these terms of use shall not constitute a waiver of such right or provision. The failure of either party to exercise in any respect any right provided for herein shall not be deemed a waiver of any further rights hereunder.\n" +
                "\n";
