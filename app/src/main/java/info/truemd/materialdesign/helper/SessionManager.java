...
import info.truemd.materialdesign.activity.LoginActivity;
...
public class SessionManager {
    ...
    private static final String PREF_NAME_UM = "TrueMDUserManangement";
    ...
    public void runLogoutOperation()
    {
        try {
            ...
            mRequester.request(Methods.GET, "http://truemd-carebook.rhcloud.com/users/sign_out.json");
