...
public class LoginActivity extends AppCompatActivity {
    ...
    TextView output;
    String loginURL = "http://truemd-carebook.rhcloud.com/users/sign_in.json";
            ...
            if(mobile.matches(regEx));
            {
               // phone_number.setError(null);
                ...
                if(valid) {
                    ...
                    String pwdUrl= "http://truemd-carebook.rhcloud.com/users/password/new?mobile="+mobile;
        ...
        public void onResponse(int requestCode, @Nullable JSONObject jsonObject) {
            ...
            try {
                ...
                if (jsonObject.toString().length()>5) {
                    ...
                    name_new= userobj.getString("name");
                    status_new= obj.getString("status");
                    user_status_new= userobj.getString("status");
                    mobile_new=userobj.getString("mobile");
                    //mobileL = mobile_new;
...
//
        ...
        public void onResponse(int requestCode, @Nullable JSONObject jsonObject) {
            ...
            try {
                if (jsonObject.toString().length()>3) {
                    ...
                    try {
                        //URL js = new URL("http://truemd-carebook.rhcloud.com/users/password/new?mobile="+mobile);
    ...
    public void reverifyUserWithOTP(final Context context, String mobile){
        ...
        try {
            ...
            mRequester.request(Methods.GET, "http://truemd-carebook.rhcloud.com/re_verify_user.json?key="+MainActivity.dev_key+"&mobile="+mobile);

            Log.e("verify_user_url: ", "http://truemd-carebook.rhcloud.com/re_verify_user.json?key="+MainActivity.dev_key+"&mobile="+mobile);
        } catch (Exception e) {
