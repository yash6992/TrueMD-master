...
import info.truemd.materialdesign.helper.SnappingHorizontalScrollView;
            ...
            new SweetAlertDialog(getActivity(), SweetAlertDialog.WARNING_TYPE)
                    ...
                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        ...
                        public void onClick(SweetAlertDialog sDialog) {
                            ...
                            getActivity().finish();
                            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=info.truemd.materialdesign"));
                            //finish();
