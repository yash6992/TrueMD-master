...
import info.truemd.materialdesign.adapter.CustomRefillAddressBSAdapter;
    ...
    public void refillOrder(){
        ...
        if(orderValid.equalsIgnoreCase("ok")){
            ...
            try {
                ...
                mRequester.request(Methods.PUT, "http://truemd-carebook.rhcloud.com/orders/"+orderdollaroid+"/refill.json", orderJsonObject);
