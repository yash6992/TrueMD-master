...
public class ForgetPwdActivity extends AppCompatActivity {
    ...
    void changePassword() {
        ...
        String pwdChangeUrl = "http://truemd-carebook.rhcloud.com/reset_password.json?reset_password_token=" + resetPwdToken + "&password=" + confirmChangedPwd.getText().toString() + "&password_confirmation=" + changedPwd.getText().toString() + "&otp=" + otp + "&key=" + MainActivity.dev_key;
