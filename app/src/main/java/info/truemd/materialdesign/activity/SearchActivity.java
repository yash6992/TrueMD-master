...
import info.truemd.materialdesign.adapter.SuggestionAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    public static String [] prgmTrueMDCodeList;
...
//        );
        ...
        prgmTrueMDCodeList = new String[30];
        ...
        searchBar.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                prgmManufacturerList= new String[30];
                prgmPackSizeList= new String[30];
                lv.setAdapter(new CustomSearchAdapter(context, prgmNameList, prgmManufacturerList, prgmPriceList, prgmPackSizeList,prgmTrueMDCodeList));
    ...
    public  void getAutocorrectMeds(String message)
    {
        try {
            ...
            mRequester.request(Methods.GET, "http://truemd-carebook.rhcloud.com/api/v2/medicines?key="+MainActivity.dev_key+"&search="+message);
            //URL js = new URL("http://truemd-carebook.rhcloud.com/api/v2/medicines?key="+MainActivity.dev_key+"&search="+temp);
...
//
                    ...
                    if(k<29){
                        ...
                        prgmTrueMDCodeList[k] = ListData.get(i).getId();
