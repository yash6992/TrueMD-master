...
import info.truemd.materialdesign.activity.PrescriptionDetailsActivity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            if (result5[position].length() < 0)
                ...
                holder.tv3.setText(TrueMDJSONUtils.goThroughNullCheck(result2[position]));
                ...
                rowView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        // TODO Auto-generated method stub
                        try {
                            Toast.makeText(context, "You Clicked " + result7[position].getJSONObject("_id").getString("$oid"), Toast.LENGTH_SHORT).show();
