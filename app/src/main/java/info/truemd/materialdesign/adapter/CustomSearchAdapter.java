...
public class CustomSearchAdapter extends BaseAdapter{
    ...
    public CustomSearchAdapter(Context c1, String[] prgmNameList,String[] prgmManufacturerList,String[] prgmPriceList,String[] prgmPacketSizeList,String[] prgmTrueMDCodeList) {
