...
import info.truemd.materialdesign.activity.TrueMDSiriFragment;
import info.truemd.materialdesign.helper.CustomHtmlTextParsing;
import info.truemd.materialdesign.helper.LongClickLinkMovementMethod;
    ...
    private class DictionaryTask extends AsyncTask<String, String, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                URL js = new URL("http://truemd-carebook.rhcloud.com/dictionary.json?q="+temp+"&source=0"+"&key="+MainActivity.dev_key);
