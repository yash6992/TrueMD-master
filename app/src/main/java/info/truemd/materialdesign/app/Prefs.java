package info.truemd.materialdesign.app;
...
public class Prefs {
    ...
    public static int getCardGap(Context context) {
        int cardGapDimenInDp = (int) (context.getResources().getDimension(R.dimen.card_gap_local) / context.getResources().getDisplayMetrics().density);
        return Pref.getInt(CARD_GAP, cardGapDimenInDp);
    }

    public static int getCardGapBottom(Context context) {
        int cardGapBottomDimenInDp = (int) (context.getResources().getDimension(R.dimen.card_gap_bottom_local) / context.getResources().getDisplayMetrics().density);
